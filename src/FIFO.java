...
public class FIFO {
	...
	public void fifo(ArrayList<String[]> lines, String[] pages, int fSize, String filename){
...
//		BinarySearchTree bst = new BinarySearchTree();
		...
		try{
	        ...
	        long outputFifo = startFifo - endFifo;
	        if(outputFifo < 0)
	        	fWriter.append("Elapsed time in ms: " + (0-outputFifo));
	        else
	        	fWriter.append("Elapsed time in ms: " + outputFifo);
